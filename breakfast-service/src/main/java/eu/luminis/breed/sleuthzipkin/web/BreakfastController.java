...
public class BreakfastController {
    ...
    public boolean getHealth() throws URISyntaxException {
        restTemplate.getForObject(servicesConfiguration.getURIPreferenceService("preference/health"), String.class);
        restTemplate.getForObject(servicesConfiguration.getURIMachineService("machine/health"), Object.class);
        return true;
    }
